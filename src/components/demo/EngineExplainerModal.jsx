...
export default function EngineExplainerModal({ onClose }) {
  const steps = [
    ...
    },
    {
      ...
      description: 'Time-series analysis identifies clinically significant patterns across 8 PANTHER categories: fasting/overnight, around mealtime, where low follows high, and around exercise — for both hypoglycemia and hyperglycemia.',
    },
    {
      title: 'PANTHER Framework Mapping',
      description: 'Detected patterns are mapped against the PANTHER clinical decision framework — evidence-based rules developed with endocrinology expertise for AID therapy optimization.',
    },
    {
