...
import { AlertTriangle, TrendingDown, Activity, CheckCircle2, ChevronDown, ChevronRight, Database, GitBranch, Lightbulb, Target, Sparkles, Check } from 'lucide-react'
        ...
        <div className={styles.deepDive}>
          ...
          <div className={styles.aiAttribution}>
            ...
            <span className={styles.aiText}>
              Generated by AI from PANTHER protocol: <strong>{ruleMatch.rule}</strong>
            </span>
          </div>
          ...
          <div className={styles.reviewSection}>
            <button
              className={`${styles.reviewButton} ${isReviewed ? styles.reviewButtonActive : ''}`}
              onClick={(e) => {
                e.stopPropagation()
